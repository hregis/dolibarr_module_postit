 ...
 *				Such a file must be copied into htdocs/postit/core/modules directory.
...
class modpostit extends DolibarrModules
{
	...
	function __construct($db)
	{
		...
		$this->numero = 104852; // 104000 to 104999 for ATM CONSULTING
		...
		$this->picto='postit@postit';

		// Defined all module parts (triggers, login, substitutions, menus, css, etc...)
		// for default path (eg: /postit/core/xxxxx) (0=disable, 1=enable)
		// for specific path of parts (eg: /postit/core/modules/barcode)
		// for specific css file (eg: /postit/css/postit.css.php)
		...
		//							'css' => array('/postit/css/postit.css.php'),	// Set this to relative path of css file if module has its own css file
	 	//							'js' => array('/postit/js/postit.js'),          // Set this to relative path of js file if module must load a js on all pages
		...
		// Example: $this->tabs = array('objecttype:+tabname1:Title1:mylangfile@postit:$user->rights->postit->read:/postit/mynewtab1.php?id=__ID__',  	// To add a new tab identified by code tabname1
        //                              'objecttype:+tabname2:Title2:mylangfile@postit:$user->rights->othermodule->read:/postit/mynewtab2.php?id=__ID__',  	// To add another new tab identified by code tabname2
        ...
        /* Example:
        if (! isset($conf->postit->enabled)) $conf->postit->enabled=0;	// This is to avoid warnings
        $this->dictionaries=array(
            'langs'=>'mylangfile@postit',
            ...
            'tabcond'=>array($conf->postit->enabled,$conf->postit->enabled,$conf->postit->enabled)												// Condition to show each dictionary
        );
        */
		...
		//							'titre'=>'postit top menu',
		//							'mainmenu'=>'postit',
		//							'leftmenu'=>'postit',
		//							'url'=>'/postit/pagetop.php',
		//							'langs'=>'mylangfile@postit',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
		//							'position'=>100,
		...
		//							'perms'=>'1',			                // Use 'perms'=>'$user->rights->postit->level1->level2' if you want your menu with a permission rules
		//							'target'=>'',
		...
		//							'titre'=>'postit left menu',
		//							'mainmenu'=>'xxx',
		//							'leftmenu'=>'postit',
		//							'url'=>'/postit/pagelevel2.php',
		//							'langs'=>'mylangfile@postit',	        // Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
		//							'position'=>100,
	...
	function init($options='')
	{
		...
		dol_include_once('/postit/config.php');
		dol_include_once('/postit/script/create-maj-base.php');
